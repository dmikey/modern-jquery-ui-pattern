...
var xtag = __webpack_require__(17);
...
var grapnel = __webpack_require__(10);
...
router.get('', function (req) {
  ...
  view.update(_store2.default.getState());
  view.appendTo('#app');
});
  ...
  _createClass(ComponentStore, [{
    ...
    value: function dispatch(action, payload) {
      ...
      subscribers.forEach(function (fn) {
        fn(_this.reduce(payload));
      });
    }
  }, {
    key: 'reduce',
    value: function reduce(payload) {
...
module.exports = "<div class=side-bar-item-container> <svg class=chevron-closed xmlns=http://www.w3.org/2000/svg width=7 height=12 viewBox=\"0 0 7 12\"> <path fill=#89A19D fillRule=evenodd d=\"M6.5 6a.502.502 0 0 1-.146.354l-5.5 5.5a.502.502 0 0 1-.708-.708L5.293 6 .146.854A.502.502 0 0 1 .854.146l5.5 5.5A.502.502 0 0 1 6.5 6z\"/> </svg> <span class=\"side-bar-item-label title value\">Item</span> </div>";

/***/ }),
/* 12 */
/***/ (function(module, exports) {

module.exports = "<div class=main-container> <div class=side-bar /> <div class=content /> </div>";
